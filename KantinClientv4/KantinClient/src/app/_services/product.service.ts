...
return this.http.get<ProductListDto>(this.baseUrl+'/Product/'+productId);
  ...
  updateProduct(productId:number,productUpdateDto:ProductUpdateDto):Observable<ProductUpdateDto>{
    return this.http.put<ProductUpdateDto>(this.baseUrl+'/Product/productUpdate/'+productId,productUpdateDto);
  }

  deleteProduct(productId:number):Observable<Product>{
    return this.http.put<Product>(this.baseUrl+'/Product/productDelete/'+productId,productId);
  }
}
